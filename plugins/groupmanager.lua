...
if not lang then
text = [[
اوامر التحذير والكتم (انكلش)👁‍🗨
⭐️⭐️⭐️⭐️⭐️⭐️⭐️
#لوضع تحذير
💎 setwarn [العدد]
💎 warn لتحذير مستخدم
💎 unwarn الغاء التحذير
〰〰〰〰〰〰⚡️
🔕 silet [للكتم]
🔔 unsilent [الغاء الكتم]
⚡ ️silentlist [المكتومين]
🔕 ban [للحضر]
🔔 unban [الغاء الحضر]
⚡ ️banlist [المحضورين]
🔕 kick [للطرد]
...
〰〰〰〰〰〰⚡️
🗯 مسح الرسائل
🗯 rmsg `[العدد]` لغاية 1000
🗯 mydel [مسح رسائلي]
🗯 rmsg all [مسح شامل]
🗯 del `[بالرد]`
〰〰〰〰〰〰⚡️
📌 clean = مع الاوامر ادناه
📌 `[bots,banlist,silentlist]`
📌 `[filterlist,abut]`
📌 `[modlist,owners,rules]`
