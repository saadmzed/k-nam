--Begin msg_checks.lua By @saad7m
...
if not redis:get('autodeltime') then
  ...
  tdcli.sendMessage(msg.to.id, "", 0, "انها ليست احدى مجموعاتي\nراسل المطور لاضافتي🦋", 0, "md")
...
return
  ...
  tdcli.sendMessage(chat, msg.id, 0, "_User_ "..user_name.." `[ "..user.." ]` _has been_ *kicked* _because of_ *flooding*", 0, "md")
   elseif lang then
  tdcli.sendMessage(chat, msg.id, 0, "_المستخدم 🐴_ "..user_name.." `[ "..user.." ]` _تم طرده بسبب التكرار_", 0, "md")
    end
